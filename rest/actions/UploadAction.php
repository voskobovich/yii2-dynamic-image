...
namespace voskobovich\image\dynamic\rest\actions;

use voskobovich\base\helpers\HttpError;
use voskobovich\image\dynamic\rest\forms\ImageUploadForm;
use Yii;
use yii\base\Action;
...
/**
 * Class UploadAction
 * @package voskobovich\image\dynamic\rest\actions
 */
